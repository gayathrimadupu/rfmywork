		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rf App",
									"targetURL": "#comapprfscreens-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapprfscreens-display": {
								"semanticObject": "comapprfscreens",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.rfscreens",
									"url": sap.ui.require.toUrl("com/app/rfscreens")
								}
							}
						}
					}
