		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Admin App",
									"targetURL": "#comappadminscreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappadminscreen-display": {
								"semanticObject": "comappadminscreen",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.adminscreen",
									"url": sap.ui.require.toUrl("com/app/adminscreen")
								}
							}
						}
					}
